...
try {
  ...
  fs.writeFileSync(usdcOutputFilePath, JSON.stringify(contractABI, null, 2));
  ...
  console.log(`ABI successfully written to ${usdcOutputFilePath} and ${contractOutputFilePath}`);
} catch (error) {
